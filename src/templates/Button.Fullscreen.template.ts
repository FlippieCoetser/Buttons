export const template = `
    <link rel="stylesheet" href="../lib/css/Button.Fullscreen.style.css">
    <div class='icon'>
        <svg class='on'
            height='24px'
            width='24px'
        ...
        <svg class='off'
            ...
            viewBox="0 0 20 20" 
            fill="#212121">
            <path d="M7.5,5.5a2,2,0,0,1-2,2h-2a.5.5,0,0,1,0-1h2a1,1,0,0,0,1-1v-2a.5.5,0,0,1,1,0ZM17,7a.5.5,0,0,1-.5.5h-2a2,2,0,0,1-2-2v-2a.5.5,0,0,1,1,0v2a1,1,0,0,0,1,1h2A.5.5,0,0,1,17,7ZM7,17a.5.5,0,0,1-.5-.5v-2a1,1,0,0,0-1-1h-2a.5.5,0,0,1,0-1h2a2,2,0,0,1,2,2v2A.5.5,0,0,1,7,17Zm6,0a.5.5,0,0,1-.5-.5v-2a2,2,0,0,1,2-2h2a.5.5,0,0,1,0,1h-2a1,1,0,0,0-1,1v2A.5.5,0,0,1,13,17Z"/>
        </svg>
    </div>`